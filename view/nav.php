		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu active">
						<a id="uploadFile"><i class="fa fa-fw fa-upload active"></i><span> Cargar archivo </span> </a>
                    </li>
					<!-- <li class="submenu">
						<a href="#"><i class="fa fa-fw fa-area-chart"></i><span> Listado </span> </a>
                    </li> -->
					...
					<!-- <li class="submenu">
                        <a href="#" class=""><i class="fa fa-fw fa-table"></i> <span> Tables </span> <span class="menu-arrow"></span></a>
							<ul class="list-unstyled">
								...
								<li class=""><a href="tables-datatable.html">Data Tables</a></li>
							</ul>
                    </li> -->
