    <div class="content-page">
        ...
        <div class="content">
			...
			<div class="row">
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Formulario de nueva difusión</h1>
                                    <ol class="breadcrumb float-right">
										<li class="breadcrumb-item">Home</li>
										<li class="breadcrumb-item active">Formulario de nueva difusión</li>
                                    </ol>
			...
			<div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-hand-pointer-o"></i> Formulario</h3>
								Llene los campos para 
							</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 hide">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-hand-pointer-o"></i> Múltiples pasos para formar una demostración</h3>
								Algunas veces, necesitarás dividir formularios largos y fastidiosos en varias partes. Vea cómo puede aprovechar los grupos de Perejil para validar fácilmente dichos formularios de pasos múltiples, paso a paso.
							</div>
